       ...
       <SwiperSlide>
        ...
        <FaTools size={50} className='text-[#CF1F1F]' />
            <h2 className=' font-mono text-[40px] text-[#E9E9E9]  '>Web Development</h2>
              <p className='w-[25vw] max-sm:w-[85vw] font-mono text-[#E9E9E9]  text-[13px]  max-lg:w-[80vw]'>As a web developer with a love for clean code and intuitive design, I create websites that not only look great but function flawlessly. Whether you need a stunning landing page, a full-fledged e-commerce site, or a custom web application, I have the skills to bring your vision to life.</p>
          </div>
        </SwiperSlide>
       <SwiperSlide> 
